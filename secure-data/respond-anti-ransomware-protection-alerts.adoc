...
---
= 通过 ASA r2 存储系统上的 AI 警报响应自主勒索软件保护
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.下一步是什么？
如果您知道存储单元活动出现浪涌，无论是一次性浪涌还是具有新常态特征的浪涌，您都应将其报告为安全。手动将这些浪涌报告为安全有助于提高 ARP 威胁评估的准确性。了解如何link:https://docs.netapp.com/us-en/ontap/anti-ransomware/manage-parameters-task.html#report-known-surges["报告已知的 ARP/AI 浪涌"^]。
