...
.关于此任务
* 以下过程显示了常见配置。具体布线取决于为存储系统订购的组件。有关全面的配置详细信息，请参见link:https://hwu.netapp.com["NetApp Hardware Universe"^]。
...
.ASA A30和ASA A50：两个双端口40/100 GbE I/O模块
[%collapsible]
=====
...
=====
.ASA A20、A30和A50：一个4端口1025 GbE I/O模块
[%collapsible]
=====
...
.ASA A20、A30和A50：一个4端口64 Gb/秒FC I/O模块
[%collapsible]
=====
...
.-20、A30和A50
--
使用随存储系统提供的存储缆线将每个控制器连接到NS224磁盘架上对应的NSM100B模块、其中可能包括以下缆线类型：
