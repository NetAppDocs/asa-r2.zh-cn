...
在某些情况下，你可能需要 link:../learn-more/cli-support.html#set-up-an-ontap-asa-r2-cluster-using-the-cli["使用ONTAP命令行界面 (CLI) 设置集群"]。例如，如果您的安全协议不允许您将笔记本电脑连接到管理交换机，或者如果您使用的是非 Windows 操作系统，则应使用 CLI。
