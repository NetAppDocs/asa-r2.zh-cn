...
NOTE: link:space-balancing.html["动态空间平衡"]默认情况下，升级到ONTAP 9.17.1 或初始化新的ONTAP 9.17.1 ASA r2 集群 14 天后启用。在ASA r2 系统上启用动态空间均衡后，您无法从ONTAP 9.17.1 版本回滚。
...
| 积极的进口关系 | 删除已激活的导入关系。link:../install-setup/set-up-data-access.html#migrate-data-from-a-third-party-storage-system["了解进口关系"]。 


| 已启用反勒索软件保护 | link:../secure-data/pause-resume-anti-ransomware-protection.html["暂停反勒索软件保护"]。 
|===